...
func (x *UXEvent) GetClientSwitchingBandMetadata() *ClientSwitchingBandMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*UXEvent_ClientSwitchingBandMetadata); ok {
...
func (x *UXEvent) GetClientSwitchingUpstreamMacMetadata() *ClientSwitchingUpstreamMacMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*UXEvent_ClientSwitchingUpstreamMacMetadata); ok {
...
func (x *UXEvent) GetMeshConnectionChangingMetadata() *MeshConnectionChangingMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*UXEvent_MeshConnectionChangingMetadata); ok {
...
func (x *UXEvent) GetMeshBackhaulLowPhyMetadata() *MeshBackhaulLowPhyMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*UXEvent_MeshBackhaulLowPhyMetadata); ok {
...
const file_spacex_api_device_common_proto_rawDesc = "" +
	...
	"\x0ehardware_index\x18\x10 \x01(\x0e2 .SpaceX.API.Device.HardwareIndexR\rhardwareIndex\x12\x1b\n" +
	...
	"\bfromBand\x18\x02 \x01(\tR\bfromBand\x12\x16\n" +
	"\x06toBand\x18\x03 \x01(\tR\x06toBand\"@\n" +
	"\"ClientSwitchingUpstreamMacMetadata\x12\x1a\n" +
	"\bclientId\x18\x01 \x01(\rR\bclientId\"\x89\x01\n" +
	...
	"\x17EVENT_SEVERITY_ADVISORY\x10\x03*\xce\x11\n" +
	...
	"\x1eEVENT_REASON_OUTAGE_INHIBIT_RF\x102\x12(\n" +
	...
	"1EVENT_REASON_ROUTER_DNS_IPV6_SERVER_FAIL_TO_START\x10!\x125\n" +
	"-EVENT_REASON_ROUTER_SET_CUSTOM_DNS_DISALLOWED\x10\"\x1a\x02\b\x01\x122\n" +
	"*EVENT_REASON_ROUTER_SET_CUSTOM_DNS_ALLOWED\x10#\x1a\x02\b\x01\x12,\n" +
	...
	"%EVENT_REASON_ROUTER_LAN_ETH_LOW_SPEED\x101\x12.\n" +
	"*EVENT_REASON_ROUTER_MESH_BACKHAUL_FLAPPING\x103*]\n" +
	...
	"\fROUTER_GEN_2\x10\xfc\a\x12\x1b\n" +
	"\x16ROUTER_MINI_COHOUSED_1\x10\xfd\a\x12\x18\n" +
	"\x13ROUTER_BLOCK_2_OR_3\x10\xfe\a\x12\x11\n" +
	...
	"\fROUTER_GEN_4\x10\x9a\bB\xd5\x01\n" +
	"\x15com.SpaceX.API.DeviceB\vCommonProtoP\x01ZIgithub.com/Eitol/starlink-client/libs/golang/client/gen/spacex/api/device\xa2\x02\x03SAD\xaa\x02\x11SpaceX.API.Device\xca\x02\x11SpaceX\\API\\Device\xe2\x02\x1dSpaceX\\API\\Device\\GPBMetadata\xea\x02\x13SpaceX::API::Deviceb\x06proto3"
