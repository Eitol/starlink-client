...
import (
	...
	integrations "github.com/Eitol/starlink-client/libs/golang/client/gen/spacex/api/telemetron/public/integrations"
...
func (SetTestModeRequest_RfMode) EnumDescriptor() ([]byte, []int) {
	return file_spacex_api_device_dish_proto_rawDescGZIP(), []int{27, 0}
}
...
func (PLCPortStats_PortStatus) EnumDescriptor() ([]byte, []int) {
	return file_spacex_api_device_dish_proto_rawDescGZIP(), []int{51, 0}
}
...
type DishGetStatusResponse struct {
	...
	AccountShard                       AccountShard                   `protobuf:"varint,1051,opt,name=account_shard,json=accountShard,proto3,enum=SpaceX.API.Device.AccountShard" json:"account_shard,omitempty"`
...
func (x *DishGetStatusResponse) GetAccountShard() AccountShard {
	if x != nil {
		return x.AccountShard
	}
	return AccountShard_ACCOUNT_SHARD_UNKNOWN
}
...
const file_spacex_api_device_dish_proto_rawDesc = "" +
	"\n" +
	"\x1cspacex/api/device/dish.proto\x12\x11SpaceX.API.Device\x1a\x1fgoogle/protobuf/timestamp.proto\x1a%spacex/api/device/account_shard.proto\x1a\x1espacex/api/device/common.proto\x1a#spacex/api/device/dish_config.proto\x1a!spacex/api/device/rssi_scan.proto\x1a8spacex/api/satellites/network/ut_disablement_codes.proto\x1aAspacex/api/telemetron/public/integrations/rate_limit_reason.proto\")\n" +
	...
	"\tlast_seen\x18\x02 \x01(\x03R\blastSeen\"\xfb\x19\n" +
	...
	"\x12downstream_routers\x18\x9a\b \x03(\v2?.SpaceX.API.Device.DishGetStatusResponse.DownstreamRoutersEntryR\x11downstreamRouters\x12E\n" +
	"\raccount_shard\x18\x9b\b \x01(\x0e2\x1f.SpaceX.API.Device.AccountShardR\faccountShard\x12\x1a\n" +
	"\bmac_flag\x18\x9c\b \x01(\bR\amacFlag\x126\n" +
	"\bnat_flag\x18\x9d\b \x01(\x0e2\x1a.SpaceX.API.Device.NatFlagR\anatFlag\x12I\n" +
	"\rbattery_stats\x18\x9e\b \x01(\v2#.SpaceX.API.Device.DishBatteryStatsR\fbatteryStats\x1ac\n" +
	...
	"\tboard_rev\x18\t \x01(\x05R\bboardRev\"\x9e\x01\n" +
	"\x10DishBatteryStats\x12&\n" +
	"\x0fstate_of_charge\x18\x01 \x01(\rR\rstateOfCharge\x12\x1f\n" +
	"\vis_charging\x18\x02 \x01(\bR\n" +
	"isCharging\x12A\n" +
	"\fpower_source\x18\x03 \x01(\x0e2\x1e.SpaceX.API.Device.PowerSourceR\vpowerSource\"\xb1\x03\n" +
	...
	"\vdish_config\x18\x01 \x01(\v2\x1d.SpaceX.API.Device.DishConfigR\n" +
	"dishConfig\"5\n" +
	"\x14DishInhibitRfRequest\x12\x1d\n" +
	"\n" +
	"inhibit_rf\x18\x01 \x01(\bR\tinhibitRf\"6\n" +
	"\x15DishInhibitRfResponse\x12\x1d\n" +
	"\n" +
	"inhibit_rf\x18\x01 \x01(\bR\tinhibitRf\"8\n" +
	...
	"\x14POWER_SOURCE_UNKNOWN\x10\x00\x12\b\n" +
	"\x04USBC\x10\x01\x12\v\n" +
	"\aBATTERY\x10\x02\x12\x14\n" +
	"\x10USBC_AND_BATTERY\x10\x03*=\n" +
	"\aNatFlag\x12\x0f\n" +
	"\vNAT_UNKNOWN\x10\x00\x12\x10\n" +
	"\fNAT_DISABLED\x10\x01\x12\x0f\n" +
	"\vNAT_ENABLED\x10\x02*C\n" +
	"\tDishState\x12\v\n" +
...
var file_spacex_api_device_dish_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_spacex_api_device_dish_proto_goTypes = []any{
	...
	(*DishGetContextRequest)(nil),           // 23: SpaceX.API.Device.DishGetContextRequest
	(*DishGetContextResponse)(nil),          // 24: SpaceX.API.Device.DishGetContextResponse
	(*DishOutage)(nil),                      // 25: SpaceX.API.Device.DishOutage
	(*DishGetHistoryResponse)(nil),          // 26: SpaceX.API.Device.DishGetHistoryResponse
	(*RouterInfo)(nil),                      // 27: SpaceX.API.Device.RouterInfo
	(*DishGetStatusResponse)(nil),           // 28: SpaceX.API.Device.DishGetStatusResponse
	(*DishGetObstructionMapRequest)(nil),    // 29: SpaceX.API.Device.DishGetObstructionMapRequest
	(*DishGetObstructionMapResponse)(nil),   // 30: SpaceX.API.Device.DishGetObstructionMapResponse
	(*DishAlerts)(nil),                      // 31: SpaceX.API.Device.DishAlerts
	(*DishReadyStates)(nil),                 // 32: SpaceX.API.Device.DishReadyStates
	(*DishGpsStats)(nil),                    // 33: SpaceX.API.Device.DishGpsStats
	(*SoftwareUpdateStats)(nil),             // 34: SpaceX.API.Device.SoftwareUpdateStats
	(*AlignmentStats)(nil),                  // 35: SpaceX.API.Device.AlignmentStats
	(*DishObstructionStats)(nil),            // 36: SpaceX.API.Device.DishObstructionStats
	(*DishUpsuStats)(nil),                   // 37: SpaceX.API.Device.DishUpsuStats
	(*DishApsStats)(nil),                    // 38: SpaceX.API.Device.DishApsStats
	(*DishBatteryStats)(nil),                // 39: SpaceX.API.Device.DishBatteryStats
	(*InitializationDurationSeconds)(nil),   // 40: SpaceX.API.Device.InitializationDurationSeconds
	(*DishAuthenticateResponse)(nil),        // 41: SpaceX.API.Device.DishAuthenticateResponse
	(*SelfTestRequest)(nil),                 // 42: SpaceX.API.Device.SelfTestRequest
	(*SelfTestResponse)(nil),                // 43: SpaceX.API.Device.SelfTestResponse
	(*SetTestModeRequest)(nil),              // 44: SpaceX.API.Device.SetTestModeRequest
	(*SetTestModeResponse)(nil),             // 45: SpaceX.API.Device.SetTestModeResponse
	(*DishSetConfigRequest)(nil),            // 46: SpaceX.API.Device.DishSetConfigRequest
	(*DishSetConfigResponse)(nil),           // 47: SpaceX.API.Device.DishSetConfigResponse
	(*DishGetConfigRequest)(nil),            // 48: SpaceX.API.Device.DishGetConfigRequest
	(*DishGetConfigResponse)(nil),           // 49: SpaceX.API.Device.DishGetConfigResponse
	(*DishInhibitRfRequest)(nil),            // 50: SpaceX.API.Device.DishInhibitRfRequest
	(*DishInhibitRfResponse)(nil),           // 51: SpaceX.API.Device.DishInhibitRfResponse
	(*DishInhibitGpsRequest)(nil),           // 52: SpaceX.API.Device.DishInhibitGpsRequest
	(*DishInhibitGpsResponse)(nil),          // 53: SpaceX.API.Device.DishInhibitGpsResponse
	(*DishGetDataRequest)(nil),              // 54: SpaceX.API.Device.DishGetDataRequest
	(*DishClearObstructionMapRequest)(nil),  // 55: SpaceX.API.Device.DishClearObstructionMapRequest
	(*DishClearObstructionMapResponse)(nil), // 56: SpaceX.API.Device.DishClearObstructionMapResponse
	(*DishActivateRssiScanRequest)(nil),     // 57: SpaceX.API.Device.DishActivateRssiScanRequest
	(*DishActivateRssiScanResponse)(nil),    // 58: SpaceX.API.Device.DishActivateRssiScanResponse
	(*DishGetRssiScanResultRequest)(nil),    // 59: SpaceX.API.Device.DishGetRssiScanResultRequest
	(*DishGetRssiScanResultResponse)(nil),   // 60: SpaceX.API.Device.DishGetRssiScanResultResponse
	(*DishFactoryResetRequest)(nil),         // 61: SpaceX.API.Device.DishFactoryResetRequest
	(*DishFactoryResetResponse)(nil),        // 62: SpaceX.API.Device.DishFactoryResetResponse
	(*ResetButtonRequest)(nil),              // 63: SpaceX.API.Device.ResetButtonRequest
	(*ResetButtonResponse)(nil),             // 64: SpaceX.API.Device.ResetButtonResponse
	(*DishStartTestModeServerRequest)(nil),  // 65: SpaceX.API.Device.DishStartTestModeServerRequest
	(*DishStartTestModeServerResponse)(nil), // 66: SpaceX.API.Device.DishStartTestModeServerResponse
	(*PLCStats)(nil),                        // 67: SpaceX.API.Device.PLCStats
	(*PLCPortStats)(nil),                    // 68: SpaceX.API.Device.PLCPortStats
	nil,                                     // 69: SpaceX.API.Device.DishGetStatusResponse.DownstreamRoutersEntry
	(*timestamppb.Timestamp)(nil),           // 70: google.protobuf.Timestamp
	(*DeviceInfo)(nil),                      // 71: SpaceX.API.Device.DeviceInfo
	(*DeviceState)(nil),                     // 72: SpaceX.API.Device.DeviceState
	(network.UtDisablementCode)(0),          // 73: SpaceX.API.Satellites.Network.UtDisablementCode
	(*EventLog)(nil),                        // 74: SpaceX.API.Device.EventLog
	(integrations.RateLimitReason)(0),       // 75: SpaceX.API.Telemetron.Public.Integrations.RateLimitReason
	(*DishConfig)(nil),                      // 76: SpaceX.API.Device.DishConfig
	(*Quaternion)(nil),                      // 77: SpaceX.API.Device.Quaternion
	(AccountShard)(0),                       // 78: SpaceX.API.Device.AccountShard
	(*ChallengeResponse)(nil),               // 79: SpaceX.API.Device.ChallengeResponse
	(*DishActivateRssiScan)(nil),            // 80: SpaceX.API.Device.DishActivateRssiScan
	(*DishGetRssiScanResult)(nil),           // 81: SpaceX.API.Device.DishGetRssiScanResult
}
var file_spacex_api_device_dish_proto_depIdxs = []int32{
	...
	70, // 1: SpaceX.API.Device.ZtlmQueryRequest.query_start_time:type_name -> google.protobuf.Timestamp
	70, // 2: SpaceX.API.Device.ZtlmQueryRequest.query_end_time:type_name -> google.protobuf.Timestamp
	71, // 3: SpaceX.API.Device.DishGetContextResponse.device_info:type_name -> SpaceX.API.Device.DeviceInfo
	72, // 4: SpaceX.API.Device.DishGetContextResponse.device_state:type_name -> SpaceX.API.Device.DeviceState
	73, // 5: SpaceX.API.Device.DishGetContextResponse.disablement_code:type_name -> SpaceX.API.Satellites.Network.UtDisablementCode
	13, // 6: SpaceX.API.Device.DishOutage.cause:type_name -> SpaceX.API.Device.DishOutage.Cause
	25, // 7: SpaceX.API.Device.DishGetHistoryResponse.outages:type_name -> SpaceX.API.Device.DishOutage
	74, // 8: SpaceX.API.Device.DishGetHistoryResponse.event_log:type_name -> SpaceX.API.Device.EventLog
	8,  // 9: SpaceX.API.Device.RouterInfo.role:type_name -> SpaceX.API.Device.RouterRole
	71, // 10: SpaceX.API.Device.DishGetStatusResponse.device_info:type_name -> SpaceX.API.Device.DeviceInfo
	72, // 11: SpaceX.API.Device.DishGetStatusResponse.device_state:type_name -> SpaceX.API.Device.DeviceState
	31, // 12: SpaceX.API.Device.DishGetStatusResponse.alerts:type_name -> SpaceX.API.Device.DishAlerts
	25, // 13: SpaceX.API.Device.DishGetStatusResponse.outage:type_name -> SpaceX.API.Device.DishOutage
	33, // 14: SpaceX.API.Device.DishGetStatusResponse.gps_stats:type_name -> SpaceX.API.Device.DishGpsStats
	36, // 15: SpaceX.API.Device.DishGetStatusResponse.obstruction_stats:type_name -> SpaceX.API.Device.DishObstructionStats
	0,  // 16: SpaceX.API.Device.DishGetStatusResponse.mobility_class:type_name -> SpaceX.API.Device.UserMobilityClass
	32, // 17: SpaceX.API.Device.DishGetStatusResponse.ready_states:type_name -> SpaceX.API.Device.DishReadyStates
	...
	34, // 21: SpaceX.API.Device.DishGetStatusResponse.software_update_stats:type_name -> SpaceX.API.Device.SoftwareUpdateStats
	35, // 22: SpaceX.API.Device.DishGetStatusResponse.alignment_stats:type_name -> SpaceX.API.Device.AlignmentStats
	4,  // 23: SpaceX.API.Device.DishGetStatusResponse.has_actuators:type_name -> SpaceX.API.Device.HasActuators
	73, // 24: SpaceX.API.Device.DishGetStatusResponse.disablement_code:type_name -> SpaceX.API.Satellites.Network.UtDisablementCode
	75, // 25: SpaceX.API.Device.DishGetStatusResponse.dl_bandwidth_restricted_reason:type_name -> SpaceX.API.Telemetron.Public.Integrations.RateLimitReason
	75, // 26: SpaceX.API.Device.DishGetStatusResponse.ul_bandwidth_restricted_reason:type_name -> SpaceX.API.Telemetron.Public.Integrations.RateLimitReason
	76, // 27: SpaceX.API.Device.DishGetStatusResponse.config:type_name -> SpaceX.API.Device.DishConfig
	40, // 28: SpaceX.API.Device.DishGetStatusResponse.initialization_duration_seconds:type_name -> SpaceX.API.Device.InitializationDurationSeconds
	67, // 29: SpaceX.API.Device.DishGetStatusResponse.plc_stats:type_name -> SpaceX.API.Device.PLCStats
	37, // 30: SpaceX.API.Device.DishGetStatusResponse.upsu_stats:type_name -> SpaceX.API.Device.DishUpsuStats
	38, // 31: SpaceX.API.Device.DishGetStatusResponse.aps_stats:type_name -> SpaceX.API.Device.DishApsStats
	77, // 32: SpaceX.API.Device.DishGetStatusResponse.ned2dish_quaternion:type_name -> SpaceX.API.Device.Quaternion
	69, // 33: SpaceX.API.Device.DishGetStatusResponse.downstream_routers:type_name -> SpaceX.API.Device.DishGetStatusResponse.DownstreamRoutersEntry
	78, // 34: SpaceX.API.Device.DishGetStatusResponse.account_shard:type_name -> SpaceX.API.Device.AccountShard
	10, // 35: SpaceX.API.Device.DishGetStatusResponse.nat_flag:type_name -> SpaceX.API.Device.NatFlag
	39, // 36: SpaceX.API.Device.DishGetStatusResponse.battery_stats:type_name -> SpaceX.API.Device.DishBatteryStats
	...
	2,  // 38: SpaceX.API.Device.SoftwareUpdateStats.software_update_state:type_name -> SpaceX.API.Device.SoftwareUpdateState
	4,  // 39: SpaceX.API.Device.AlignmentStats.has_actuators:type_name -> SpaceX.API.Device.HasActuators
	5,  // 40: SpaceX.API.Device.AlignmentStats.actuator_state:type_name -> SpaceX.API.Device.ActuatorState
	6,  // 41: SpaceX.API.Device.AlignmentStats.attitude_estimation_state:type_name -> SpaceX.API.Device.AttitudeEstimationState
	9,  // 42: SpaceX.API.Device.DishBatteryStats.power_source:type_name -> SpaceX.API.Device.PowerSource
	79, // 43: SpaceX.API.Device.DishAuthenticateResponse.dish:type_name -> SpaceX.API.Device.ChallengeResponse
	14, // 44: SpaceX.API.Device.SetTestModeRequest.rf_mode:type_name -> SpaceX.API.Device.SetTestModeRequest.RfMode
	76, // 45: SpaceX.API.Device.DishSetConfigRequest.dish_config:type_name -> SpaceX.API.Device.DishConfig
	76, // 46: SpaceX.API.Device.DishSetConfigResponse.updated_dish_config:type_name -> SpaceX.API.Device.DishConfig
	76, // 47: SpaceX.API.Device.DishGetConfigResponse.dish_config:type_name -> SpaceX.API.Device.DishConfig
	80, // 48: SpaceX.API.Device.DishActivateRssiScanRequest.scan_query:type_name -> SpaceX.API.Device.DishActivateRssiScan
	81, // 49: SpaceX.API.Device.DishGetRssiScanResultResponse.result:type_name -> SpaceX.API.Device.DishGetRssiScanResult
	68, // 50: SpaceX.API.Device.PLCStats.port_1_stats:type_name -> SpaceX.API.Device.PLCPortStats
	68, // 51: SpaceX.API.Device.PLCStats.port_2_stats:type_name -> SpaceX.API.Device.PLCPortStats
	68, // 52: SpaceX.API.Device.PLCStats.port_3_stats:type_name -> SpaceX.API.Device.PLCPortStats
	15, // 53: SpaceX.API.Device.PLCStats.plc_revision:type_name -> SpaceX.API.Device.PLCStats.ProtocolRevision
	16, // 54: SpaceX.API.Device.PLCPortStats.status:type_name -> SpaceX.API.Device.PLCPortStats.PortStatus
	27, // 55: SpaceX.API.Device.DishGetStatusResponse.DownstreamRoutersEntry.value:type_name -> SpaceX.API.Device.RouterInfo
...
func file_spacex_api_device_dish_proto_init() {
	...
	file_spacex_api_device_account_shard_proto_init()
