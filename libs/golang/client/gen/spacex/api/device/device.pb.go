...
func (x *Request) GetZtlmQuery() *ZtlmQueryRequest {
	if x != nil {
		if x, ok := x.Request.(*Request_ZtlmQuery); ok {
			return x.ZtlmQuery
		}
	}
	return nil
...
func (x *Request) GetDishStartTestModeServer() *DishStartTestModeServerRequest {
	if x != nil {
		if x, ok := x.Request.(*Request_DishStartTestModeServer); ok {
...
func (x *Response) GetZtlmQuery() *ZtlmQueryResponse {
	if x != nil {
		if x, ok := x.Response.(*Response_ZtlmQuery); ok {
			return x.ZtlmQuery
		}
	}
	return nil
...
func (x *Response) GetDishStartTestModeServer() *DishStartTestModeServerResponse {
	if x != nil {
		if x, ok := x.Response.(*Response_DishStartTestModeServer); ok {
			return x.DishStartTestModeServer
		}
	}
	return nil
...
const file_spacex_api_device_device_proto_rawDesc = "" +
	"\n" +
	"\x1espacex/api/device/device.proto\x12\x11SpaceX.API.Device\x1a%spacex/api/common/status/status.proto\x1a\x1fspacex/api/device/command.proto\x1a\x1espacex/api/device/common.proto\x1a\x1cspacex/api/device/dish.proto\x1a\x1cspacex/api/device/gnss.proto\x1a#spacex/api/device/transceiver.proto\x1a\x1cspacex/api/device/wifi.proto\x1a/spacex/api/device/services/unlock/service.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x92\x01\n" +
	"\bToDevice\x126\n" +
	...
	"\x06Handle\x12\x1a.SpaceX.API.Device.Request\x1a\x1b.SpaceX.API.Device.ResponseB\xd5\x01\n" +
	"\x15com.SpaceX.API.DeviceB\vDeviceProtoP\x01ZIgithub.com/Eitol/starlink-client/libs/golang/client/gen/spacex/api/device\xa2\x02\x03SAD\xaa\x02\x11SpaceX.API.Device\xca\x02\x11SpaceX\\API\\Device\xe2\x02\x1dSpaceX\\API\\Device\\GPBMetadata\xea\x02\x13SpaceX::API::Deviceb\x06proto3"
