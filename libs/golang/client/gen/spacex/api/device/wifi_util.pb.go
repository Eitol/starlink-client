...
const file_spacex_api_device_wifi_util_proto_rawDesc = "" +
	...
	"preference\x12\x16\n" +
	"\x06domain\x18\b \x01(\tR\x06domain\"\xbf\x01\n" +
	"\tDhcpLease\x12\x1d\n" +
	"\n" +
	...
	"\tclient_id\x18\x06 \x01(\rR\bclientId\"\x95\x01\n" +
	"\n" +
	"DhcpServer\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12\x16\n" +
	"\x06subnet\x18\x02 \x01(\tR\x06subnet\x124\n" +
	"\x06leases\x18\x03 \x03(\v2\x1c.SpaceX.API.Device.DhcpLeaseR\x06leases\x12!\n" +
	"\fip_exhausted\x18\x04 \x01(\bR\vipExhausted\"\xe8\x04\n" +
	...
	"\x19accounting_response_count\x18\b \x01(\rR\x17accountingResponseCount\"\xe8\x02\n" +
	"\bPoeStats\x128\n" +
	...
	"\bvsns_vin\x18\a \x01(\x02R\avsnsVin\"\xbc\x02\n" +
	...
	"\x14WifiSetupRequirement\x12B\n" +
	"\x05state\x18\x01 \x01(\x0e2,.SpaceX.API.Device.WifiSetupRequirementStateR\x05state\x126\n" +
	...
	"\x0fFLASHING_FAILED\x10\f*q\n" +
	"\x19WifiSetupRequirementState\x12\x10\n" +
	"\fNOT_REQUIRED\x10\x00\x12\x16\n" +
	"\x12REQUIRED_COUNTDOWN\x10\x01\x12\x13\n" +
	"\x0fREQUIRED_PAUSED\x10\x02\x12\x15\n" +
	"\x11REQUIRED_COMPLETE\x10\x03*\x98\x02\n" +
	"\x1aCalibrationPartitionsState\x12,\n" +
	"(CALIBRATION_PARTITIONS_STATE_UNSPECIFIED\x10\x00\x122\n" +
	".CALIBRATION_PARTITIONS_STATE_ABSENT_BOTH_SIDES\x10\x01\x12/\n" +
	"+CALIBRATION_PARTITIONS_STATE_CONTENTS_EQUAL\x10\x02\x123\n" +
	"/CALIBRATION_PARTITIONS_STATE_CONTENTS_NOT_EQUAL\x10\x03\x122\n" +
	".CALIBRATION_PARTITIONS_STATE_COMPARISON_FAILED\x10\x04B\xd7\x01\n" +
	"\x15com.SpaceX.API.DeviceB\rWifiUtilProtoP\x01ZIgithub.com/Eitol/starlink-client/libs/golang/client/gen/spacex/api/device\xa2\x02\x03SAD\xaa\x02\x11SpaceX.API.Device\xca\x02\x11SpaceX\\API\\Device\xe2\x02\x1dSpaceX\\API\\Device\\GPBMetadata\xea\x02\x13SpaceX::API::Deviceb\x06proto3"
